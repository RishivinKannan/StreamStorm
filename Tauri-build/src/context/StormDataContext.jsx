...
const StormDataProvider = ({ children }) => {
    ...
    const [hostAddress] = useLocalStorageState(
        'hostAddress',
    ...
    const [subscribeWaitTimeHelperText, setSubscribeWaitTimeHelperText] =
        useState('');
    ...
    const [startChannelIndexHelperText, setStartChannelIndexHelperText] =
        useState('');

    const [endChannelIndex, setEndChannelIndex] = useState(0);
    const [endChannelIndexError, setEndChannelIndexError] = useState(false);
    const [endChannelIndexHelperText, setEndChannelIndexHelperText] =
        useState('');

    const [advancedSelectedChannels, setAdvancedSelectedChannels] = useState(
        []
    );
    const [advancedChannelsErrorText, setAdvancedChannelsErrorText] =
        useState('');
    ...
    const formControls = {
        ...
        setSubscribeAndWait,
        subscribeWaitTime,
        setSubscribeWaitTime,
        subscribeWaitTimeError,
        setSubscribeWaitTimeError,
        subscribeWaitTimeHelperText,
        setSubscribeWaitTimeHelperText,
        slowMode,
        setSlowMode,
        slowModeError,
        setSlowModeError,
        ...
        setNoOfChannels,
        noOfChannelsError,
        setNoOfChannelsError,
        noOfChannelsHelperText,
        setNoOfChannelsHelperText,
        startChannelIndex,
        setStartChannelIndex,
        startChannelIndexError,
        setStartChannelIndexError,
        startChannelIndexHelperText,
        setStartChannelIndexHelperText,
        endChannelIndex,
        setEndChannelIndex,
        endChannelIndexError,
        setEndChannelIndexError,
        endChannelIndexHelperText,
        setEndChannelIndexHelperText,
        advancedSelectedChannels,
        setAdvancedSelectedChannels,
        advancedChannelsErrorText,
        setAdvancedChannelsErrorText,
        loadInBackground,
        setLoadInBackground,
        errorText,
        setErrorText,

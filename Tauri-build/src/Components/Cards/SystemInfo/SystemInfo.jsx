                ...
                <div className="system-info-container">
                    <div className="system-info-item">
                        <div className="ram-value-container">
                            ...
                            <span className={`ram-value-${colorScheme}`}>
                                {systemInfoControls.availableRAM
                                    ? `${systemInfoControls.availableRAM} MB`
                                    : 'N/A'}
                            </span>
                        </div>
                        <Button
                            startIcon={
                                <RefreshCw
                                    size={15}
                                    className={fetchingRAM ? 'spin' : ''}
                                />
                            }
                            variant="contained"
                            sx={{ ...btnProps, marginTop: '1rem' }}
                            onClick={refreshRAM}
                        >
                            Refresh RAM
                        </Button>
                        <span className="ram-note">
                            To operate one channel you need approximately{' '}
                            {systemInfoControls.RAM_PER_PROFILE}MB of Free RAM.
                        </span>
                        <span className="ram-note">
                            {systemInfoControls.availableRAM

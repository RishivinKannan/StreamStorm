...
const LeftPanel = () => {
    ...
    const handleAdvancedChannelSelection = async () => {
        const selectedChannels = await dialogs.open(AddChannels, {
            mode: 'new',
            formControls,
            defaultSelectedChannels: formControls.advancedSelectedChannels.map(
    ...
    return (
        <div className="left-panel-container">
            ...
            <div className="left-panel-switches-container">
                <div
                    className={`switch-container ${colorScheme}-bordered-container`}
                >
                    <span className="switch-label">Subscribe</span>
                    <Switch
                        checked={formControls.subscribe}
                        disabled={
                            formControls.stormInProgress || formControls.loading
                        }
                        onChange={(e) => {
                            if (!e.target.checked) {
            ...
            <div className="times-input-container">
                ...
                {formControls.subscribeAndWait ? (
                    <TextField
                        ...
                        onChange={(e) => {
                            formControls.setSubscribeWaitTime(
            ...
            <div className="channel-index-inputs-container">
                <span className="channel-index-input-heading">
                    Channels Selection
                </span>
                ...
                <div className="channel-index-input-radio-container">
                    <RadioGroup
                        ...
                        onChange={(e) =>
                            formControls.setChannelSelection(e.target.value)
                        }
                        disabled={
                            formControls.stormInProgress || formControls.loading
                        }
                    >
                        <div className="channel-index-radio-container">
                            ...
                            />
                            <span className="channel-index-input-label">
                                Basic
                            </span>
                        </div>
                        <div className="channel-index-radio-container">
                        ...
                        <div className="channel-index-radio-container">
                            <Radio
                                value="advanced"
                                checked={
                                    formControls.channelSelection === 'advanced'
                                }
                                disabled={
                                    formControls.stormInProgress ||
                                    formControls.loading
                        ...
                        {formControls.channelSelection === 'intermediate' ? (
                            <div className="channel-selection-intermediate-container">
                                <TextField
                                    ...
                                    onChange={(e) => {
                                        formControls.setStartChannelIndex(
                                            parseInt(e.target.value)
                                        );
                                        formControls.setStartChannelIndexError(
                                            false
                                        );
                                    ...
                                    helperText={
                                        formControls.startChannelIndexHelperText
                                    }
                                    disabled={
                                        formControls.stormInProgress ||
                                        formControls.loading
                                ...
                                <TextField
                                    ...
                                    onChange={(e) => {
                                        formControls.setEndChannelIndex(
                                            parseInt(e.target.value)
                                        );
                                        formControls.setEndChannelIndexError(
                                            false
                                        );
                                    ...
                                    helperText={
                                        formControls.endChannelIndexHelperText
                                    }
                                    disabled={
                                        formControls.stormInProgress ||
                                        formControls.loading
                            ...
                            <div className="channel-selection-advanced-container">
                                ...
                                >
                                    ...
                                    {
                                        formControls.advancedSelectedChannels
                                            .length
                                    }
                                </span>
                                ...
                                <ErrorText
                                    errorText={
                                        formControls.advancedChannelsErrorText
                                    }
                                />
                            </div>
                        )}
                ...
                {formControls.channelSelection === 'intermediate' ? (
                    <span className="channel-selection-note">
                        Note: Index starts from 1, and the end index is
                        inclusive.
                    </span>
                ) : null}
            </div>

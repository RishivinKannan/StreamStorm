...
const StormControls = () => {
    ...
    useEffect(() => {
        formControls.SC.current = new StormControlsClass(
        ...
        formControls.SC.current.setChangeMessagesLoading =
            setChangeMessagesLoading;
        formControls.SC.current.setChangeSlowModeLoading =
            setChangeSlowModeLoading;
        ...
        const confirmed = await dialogs.open(AreYouSure, {
            text: (
                <span>
                    ...
                    <strong style={{ color: 'var(--input-active-red-dark)' }}>
                        STOP
                    </strong>{' '}
                    the ongoing storm?
                </span>
    ...
    const handleChangeMessages = async () => {
        ...
        formControls.SC.current.changeMessages(
            messages,
            formControls.setMessages,
            formControls.setMessagesString
        );
    };
        ...
        const confirmed = await dialogs.open(AreYouSure, {
            text: (
                <span>
                    ...
                    for all the channels to be ready?
                </span>
            ),
        });
    ...
    const handleChangeSlowMode = async () => {
        ...
        formControls.SC.current.changeSlowMode(
            slowModeValue,
            formControls.setSlowMode
        );
    };
    ...
    return (
        <div className="storm-controls-container">
            ...
            {formControls.stormInProgress && (
                <div
                    className={`storm-in-progress-container ${colorScheme}-bordered-container`}
                >
                    <Ping />
                    <span
                        className={`storm-in-progress-text ${colorScheme}-text`}
                    >
                        A Storm is in progress...
                    </span>
                </div>
            )}
            ...
            <div className="storm-controls-btns-container">
                <div className="row">
                    <Button
                        ...
                        onClick={handlePause}
                        disabled={
                            controlsDisabled || !formControls.stormInProgress
                        }
                    >
                ...
                <div className="row">
                    ...
                    <Tooltip
                        title="Start storming on more channels"
                        placement="right"
                    >
                        <Fragment>
                            <Button
